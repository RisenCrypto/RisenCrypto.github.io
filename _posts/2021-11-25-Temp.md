...
Let's see how to construct this curve over $F_{2^4}$. In case of elliptic curves over an Extension Field, we have 2 equations - the Ellipic Curve equation & the polynomials. We will use $x$ & $y$ for the Curve equation & $t$ as the variable for the Polynomials.
