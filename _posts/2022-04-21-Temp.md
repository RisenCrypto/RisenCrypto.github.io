...
$y^{\frac {p-1}{p_i^{n_i}}} = g^{\frac {(p-1){x_i}}{p_i^{n_i}}} \bmod p$

Raise both sides by $(p_i)^{n_i - 1}$


$= g^{\frac {(p-1){x_i}}{p_i}} \bmod p$

Substitute $x_i = {a_0+a_1{p_i}+a_2{p_i}^2+ a_3{p_i}^3 + …}$

$= g^{\frac {(p-1){(a_0+a_1{p_i}+a_2{p_i}^2+a_3{p_i}^3 + …})}{p_i}} \bmod p$

$= g^{\frac {(p-1)a_0}{p_i}}. g^{(p-1)a_1}. g^{(p-1){a_2}{p_i}}.g^{(p-1){a_3}{p_i}^2} .... \bmod p $
...
$y^{\frac {p-1}{p_i^{n_i}}} = g^{\frac {(p-1)a_0}{p_i}} \bmod p $
