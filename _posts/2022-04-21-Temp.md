...
${y_i}^{\frac{p−1}{p_i}} \equiv (g^{a_0+a_1{p_1}+a_2{p_1}^2+…})^{\frac {p−1}{p_1}} \bmod p$ [Raise both sides to $\frac {p−1}{p_1}$]

${y_i}^{\frac {p−1}{p_1}} \equiv g^{(a_0+a_1{p_1}+a_2{p_1}^22+…)(\frac {p−1}{p_1})} \bmod p$

${y_i}^{\frac {p−1}{p_1}} \equiv g^{a_0 \frac {p−1} {p_1}} . g^{a_1{p_1}\frac{p−1}{p_1}}.g^{a_2{p_1}^2 \frac{p−1}{p_1}}… \bmod p$   
