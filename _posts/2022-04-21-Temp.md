...
Since each of the prime powers ${p_i}^{n_i}$ divides the order of the group, by the Fundamental Theorem of Cyclic Groups, there will be a cyclic subgroup of order ${p_i}^{n_i}$ with the generator for the subgroup being $g^{\frac {p-1} {x}}$ 
