...
- $\lbrace u, u_1, u_2  \in U \rbrace$ , $\lbrace v, v_1, v_2 \in V \rbrace$ & any scalar $\alpha$
- $f_1 : V \mapsto W f_1 is a map from $V$ to $W$)
- $f_2 : U$ X $V \mapsto W (f_2 is a map from $U$ X $V$ to $W\\\\$
