...
1) Compute the order of the Elliptic Curve over the Extension field i.e. $n = \#E(\mathbb F_{q^k})$. Since the $m$-Torsion group of $E(\mathbb F_p)$, is a subgroup of $E(\mathbb F_{q^k})$, $m$ divides $n$
