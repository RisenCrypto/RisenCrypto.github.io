...
$E$ be an elliptic curve defined over a prime field $\mathbb F_q$. A point $P \in E$ satisfying $mP = \mathcal O$ (point at infinity) is called a point of order $m$ in the group $E$. The set of all points of order $m$ in the group is denoted by $E[m] = \lbrace P \in E : mP = \mathcal O \rbrace$ - i.e. the set of $m$-torsion points.
