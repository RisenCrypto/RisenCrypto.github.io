...
So $m = (g^{\frac {p-1}{{p_1}^2}})^{a_0}$. Since $p_1^2$ is a factor of the order of the group, $g^{\frac {p-1}{{p_1}^2}}$ is a generator of a subgroup. Hence $m$ is an element of the field & has an inverse $m^{-1}$ in the field.
