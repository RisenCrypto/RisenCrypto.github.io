...
Consider the extension field F_q^k. The multiplicative group of F_q^k is F*_q^k whose order is one less than q (because of excluding 0).
Since n divides the order of F_q^k, F_q^k has a unique subgroup of order n (by the Fundamental Theorem of Cyclic Groups).
