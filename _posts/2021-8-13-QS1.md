...
Here is an Google Spreadsheet which shows the Sieving process.  
...
Cells D7:R58 contain the same formula (adjusted for Row & Column Numbers). This is the Formula in D7 "=If(Mod($A7,D$3) = D$5,Sieve(C7,D$3),C7)"

It conditionally calls the function Sieve which does the Sieving 
