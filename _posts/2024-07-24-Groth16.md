...
Though Groth16 doesn't exactly use KZG Commitments, it uses something very similar. If you are not familiar with this type of Polynomial Commitment Schemes, you can go through this post on [KZG](/Kate/). It will introduce you to both Polynomial Commitment Schemes & Elliptic Curve Pairings.
...
Groth16 Trusted Setup has 2 phases - the above is Phase 1 or Universal Setup. If you create a Phase 1 setup of $n$ gates, it can be reused for any Circuit which has $n$ or less gates. $\tau$ is destroyed after Phase 1 is over. 
