...
Now, $C_F = Q(a)\cdot G$ & $C_Q = F(a)\cdot G$. So substituting, we get
...
$e(C_Q, aG - bG) \stackrel {?}{=} e(C_F - c\cdot G, G)$
...
An Elliptic Curve Pairing is defined as  

$e_m : \mathbb G_1 \times \mathbb G_2 \mapsto \mathbb G_T$  

$\mathbb G_1$ can be equal to $\mathbb G_2$ i.e. $\mathbb G_1 = \mathbb G_2 = \mathbb G$. Such a pairing is called as a Symmetric Pairing. We used a symmetric pairing to prove the correctness of the above verification equation.

However, an Asymmetric Pairing (i.e. $\mathbb G_1 \ne \mathbb G_2$) can also be used & is usually preferred. The proof for the verify equation using Asymmetric Pairings is very similar. Let the generators of the 2 Groups be $G_1$ & $G_2$ respectivley. 
...
$e((a-b)\cdot C_Q,G_2) \stackrel {?}{=} e(C_F - G_1\cdot c, G_2)$
