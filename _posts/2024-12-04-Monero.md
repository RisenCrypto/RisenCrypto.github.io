...
A Monero Spend Transaction data comprises of the following JSON structure, the JSON field name in bold & what it represents in brackets. I have skipped some fields which aren't significant
...
- **rct_signatures** (data about the transaction)
