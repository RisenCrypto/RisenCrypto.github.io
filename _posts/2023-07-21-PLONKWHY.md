...
$H = \lbrace 1, \omega, \omega^2, \omega^3, ..., \omega^{k-1} \rbrace$ 
...
$Z_H = (x-1) \star(x-\omega)\star (x-\omega^2)\star ...\star (x-\omega^{k-1})$
...
- For $x = 1$,
  ...
  $1^k = 1$, so $(x-1)$ is a root of $x^k - 1$
...
So $x^k - 1 = (x-1) \star(x-\omega)\star (x-\omega^2)\star ...\star (x-\omega^{k-1})$
...
$M(1)\star M(\omega) \star M(\omega^2) \star \cdots \star M(\omega^{k-1}) = 1$
...
2) Proving $R(\omega)$ was built accumulatively from the earlier $R$'s
...
$H = \lbrace 1,\omega, \omega^2, \omega^3, ..., \omega^{k-1} \rbrace$, where multiplying by each element  $\omega$ gives us the next element & thus we get the "right shift" relation between $R$ at an element & $R$ at the next element.
