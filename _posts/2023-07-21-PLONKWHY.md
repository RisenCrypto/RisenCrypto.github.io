...
layout: post
mathjax: true
title: Few questions answered about 𝒫𝔩𝔬𝔫𝒦
---
...
Take a look at [$\mathcal{P} \mathfrak{lon}\mathcal{K}$'s Permutation proof](/$\mathcal{P} \mathfrak{lon}\mathcal{K}$Perm#the-proof).
