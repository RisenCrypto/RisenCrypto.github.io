...
For e.g. for the prime $p_i$, the roots of $N \bmod p_i$ will help figure out.
...
In our list LS if we start the indexing with 0, this means that the 8th & 11th number will be divisible by 13.  
Also, 8+13, 8+26, 8+39th etc & 11+13, 11+26 + 11+39th etc number will be divisible.  
