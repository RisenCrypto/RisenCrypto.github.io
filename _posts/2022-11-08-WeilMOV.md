...
The Full Torsion Group has subgroups, two of which are of importance in the Weil Pairing.  

- $G_1$ - all points in this subgroup are in the Curve over the base field i.e. they are in $E(\mathbb F_p)$. 

- $G_2$ - all points in this subgroup are in $E(\mathbb F_{p^k})$ with none of them being in $E(\mathbb F_q)$. There are multiple such subgroups in the full-torsion group, we can work in any of them.
