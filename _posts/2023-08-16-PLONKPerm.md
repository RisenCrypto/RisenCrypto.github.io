...
To simplify the above example, we used gate numbers 1, 2, 3 etc. However, as [explained here](/PLONKWHY#multiplicative-subgroup), PLONK uses elements of a multiplicative subgroup $H = \lbrace 1, \omega, \omega^2, \omega^3, â€¦, \omega^{n-1} \rbrace$ to number the gates
